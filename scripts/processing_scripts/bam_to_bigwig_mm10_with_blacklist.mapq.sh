...
bl=$4
minmapq=$5
[[ $minmapq != [0-9]* ]] && echo "Must be integer: $minmapq" && exit 1
...
bamCoverage --bam $inbam -o $outbw --binSize $bsize --normalizeUsing CPM --blackListFileName $bl --skipNAs --minMappingQuality $minmapq
