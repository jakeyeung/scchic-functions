...
echo "bamCoverage --bam $inbam -o $outbw --binSize $bsize --normalizeUsing None --blackListFileName $bl --skipNAs --Offset 1 2 --scaleFactor $sf"
bamCoverage --bam $inbam -o $outbw --binSize $bsize --normalizeUsing None --blackListFileName $bl --skipNAs --Offset 1 2 --scaleFactor $sf --verbose
