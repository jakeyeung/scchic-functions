...
# bamCoverage --bam $inbam -o $outbw --binSize $bsize --blackListFileName $bl --skipNAs --normalizeUsing RPGC --effectiveGenomeSize 2652783500
bamCoverage --bam $inbam -o $outbw --binSize $bsize --blackListFileName $bl --skipNAs --normalizeUsing RPGC --effectiveGenomeSize 1369631918   #ZF size
